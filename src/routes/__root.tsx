...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Concours de pronostics de la Coupe du Monde 2026 — Sequedin, Faidherbe, Wattrelos, PC Bus et Tram (Keolis / Ilévia)." },
      ...
      { property: "og:description", content: "Concours de pronostics de la Coupe du Monde 2026 — Sequedin, Faidherbe, Wattrelos, PC Bus et Tram (Keolis / Ilévia)." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Pronostics CDM 2026" },
      { name: "twitter:description", content: "Concours de pronostics de la Coupe du Monde 2026 — Sequedin, Faidherbe, Wattrelos, PC Bus et Tram (Keolis / Ilévia)." },
