        ...
        <div className="relative container mx-auto grid items-center gap-10 px-4 py-16 sm:py-24 lg:grid-cols-2">
          ...
          >
            ...
            <img
              ...
              className="relative h-[48rem] w-[48rem] object-contain drop-shadow-[0_12px_40px_rgba(217,165,40,0.55)] sm:h-[72rem] sm:w-[72rem] lg:h-[96rem] lg:w-[96rem]"
            />
          </motion.div>
        ...
        <section id="choisis-ton-unite" className="container mx-auto px-4 py-12 scroll-mt-24">
          ...
          >
            {[
              ...
              { value: "copem", label: "COPEM", logo: logoCopem.url, scale: 1 },
            ].map((d, i) => (
