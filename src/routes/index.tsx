...
import fifaWc2026 from "@/assets/logo-concours-crest.png.asset.json";
...
function Home() {
  ...
  return (
    <div className="overflow-x-hidden">
        ...
        <div className="relative container mx-auto grid items-center gap-10 px-4 py-16 sm:py-24 lg:grid-cols-2">
          ...
          >
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-white/5 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-amber-300 backdrop-blur">
              ...
              Sequedin · Faidherbe · Wattrelos · PC Bus · Tram · COPEM · Équipe Support
            </div>
          ...
          >
            ...
            <img
              ...
              className="relative h-48 w-48 select-none object-contain sm:h-72 sm:w-72 lg:h-[26rem] lg:w-[26rem]"
            />
          </motion.div>
      ...
      >
        {[
          { icon: Users, t: "Entre collègues", d: "Ouvert au personnel des dépôts Sequedin, Faidherbe, Wattrelos, PC Bus, Tram, COPEM et Équipe Support." },
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="mx-auto mt-12 max-w-xl">
          ...
          <motion.p
            ...
            transition={{ duration: 0.5, delay: 0.1 }}
            className="mt-2 text-center text-sm text-muted-foreground"
          >Chaque unité a son propre podium. À l'issue de la finale, les 3 meilleurs pronostiqueurs de chaque unité (Sequedin, Faidherbe, Wattrelos, PC Bus, Tram, COPEM et Équipe Support) sont récompensés séparément :</motion.p>
      ...
      >
        <div className="container mx-auto grid gap-8 px-4 py-12 md:grid-cols-3">
          ...
          <motion.ol variants={staggerContainer} className="md:col-span-2 space-y-4">
            {[
              ["1. Créez votre compte", "Utilisez votre numéro de paie et votre prénom, puis définissez votre mot de passe !"],
              ["2. Pronostiquez", "Saisissez le score que vous prévoyez pour chaque rencontre. N'oubliez pas, vos choix sont modifiables jusqu'à H-1."],
              ["3. Suivez le classement", "Vos points sont calculés et le classement est actualisé automatiquement après chaque match."],
            ].map(([t, d]) => (
