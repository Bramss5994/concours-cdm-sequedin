...
const DEPOTS = ["sequedin", "faidherbe", "wattrelos", "pc_bus", "tram", "copem", "support"] as const;
...
const DEPOT_ENUM = z.enum(["sequedin", "faidherbe", "wattrelos", "pc_bus", "tram", "copem", "support"]);
