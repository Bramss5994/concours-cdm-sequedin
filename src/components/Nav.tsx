...
import { Trophy, Calendar, BarChart3, User as UserIcon, Shield, LogOut, LogIn, Menu, X, Target, ScrollText, Crown, Zap } from "lucide-react";
...
export function Nav() {
  ...
  const links = [
    ...
    { to: "/saisie-rapide", label: "Saisie rapide", icon: Zap },
